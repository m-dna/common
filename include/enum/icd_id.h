...
enum class IcdId : uint16_t {
  ...
  CONTROL_TEST_MISSILE_TARGET_STATE = 0x001C, // 제어시험 미사일/표적 상태 (control_test_missile_target_state)
  CONTROL_TEST_ATTITUDE_FEEDBACK = 0x001D, // 제어시험 자세 피드백 (control_test_attitude_feedback)
